...
if __name__ == '__main__':
    ...
    if cfg.simulator == "Cadmium":
        print("Done. Parsing structure file...")
        structure = CadmiumStructure().parse(cfg.files)

        print("Done. Parsing log file with Cadmium Cell-DEVS parser...")
        messages = CadmiumState(structure).parse(cfg.files)
